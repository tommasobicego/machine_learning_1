...
## Synopsis
The task of the project is to correctly identify how well the test subjects executed lifts, by analysing the data obtained thanks to accelerometers located on the belt, forearm, arm, and dumbell of the participants. How well means to identify in which of the five different *classes* the particular lift execution falls.
...
Then I read the datasets

```{r, echo=TRUE, results='hide', cache=TRUE}
train_csv <- read.csv("C://Users/CSP/Downloads/pml-training.csv",stringsAsFactors = TRUE)
test_csv <- read.csv("C://Users/CSP/Downloads/pml-testing.csv")
``` 
